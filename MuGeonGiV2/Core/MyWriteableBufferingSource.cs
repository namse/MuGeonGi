...
{
    public class MyWriteableBufferingSource : IWaveSource
    {
        private readonly WaveFormat _waveFormat;
        private MyFixedSizeBuffer<byte> _buffer;
        ...
        public MyWriteableBufferingSource(WaveFormat waveFormat)
            : this(waveFormat, waveFormat.BytesPerSecond * 1)
        {
        }
